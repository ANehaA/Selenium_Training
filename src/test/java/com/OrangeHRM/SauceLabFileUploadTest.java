...
public class SauceLabFileUploadTest {
	 WebDriver driver;
	  public static final String USERNAME = "nehaSN";
	    public static final String ACCESS_KEY = "931cd87b-1b85-40c4-87bd-d7dc0906bc69";
